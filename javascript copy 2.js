...
function defaultStyles() {
  ...
  const errFontSize = "12px";
  const errTextAlign = "center";
  const errBgColor = "var(--my-black)";
  const errTopText = "ERROR"
...
function errorStyleLo() {
displayCurrNum.style.backgroundColor = errBgColor;
displayCurrNum.style.color = "yellowgreen";
displayCurrNum.style.fontSize = errFontSize;
displayCurrNum.style.textAlign = errTextAlign;
displayPrevNum.style.backgroundColor = errBgColor;
displayPrevNum.style.color = "yellowgreen";
displayPrevNum.style.fontSize = errFontSize;
displayPrevNum.style.textAlign = errTextAlign;
}

function errorStyleMd() {

}

function errorStyleHi() {
...
function computeRomanNumeral() {
  ...
  if (isNaN(current)) {
    ...
    console.log(specKeyCase);
      ...
      displayPrevNum.innerText = errTopText;
  }
console.log(`Current is ${current} and is a ${typeof current}`);
...
if (typeof current === "number") {
  if (Number.isInteger(current) && current > 0 && current < 171) {
    ...
    if (current.includes(".") || current < 1 ) {
      ...
      displayCurrNum.style.backgroundColor = "var(--my-black)";
